...
var AutocompleteFieldComponent = function (_React$Component) {
  _inherits(AutocompleteFieldComponent, _React$Component);

  function AutocompleteFieldComponent(props) {
    _classCallCheck(this, AutocompleteFieldComponent);

    var _this = _possibleConstructorReturn(this, (AutocompleteFieldComponent.__proto__ || Object.getPrototypeOf(AutocompleteFieldComponent)).call(this, props));
  ...
  _createClass(AutocompleteFieldComponent, [{
    ...
    value: function onChange(option) {
      if (this.state.multi) {
        var options = option.map(function (o) {
          return o.value;
        });
...
exports.AutocompleteField = AutocompleteFieldComponent;