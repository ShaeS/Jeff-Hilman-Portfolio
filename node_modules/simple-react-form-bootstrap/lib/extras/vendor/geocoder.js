...
if (function (a) {
    ...
    a.ProviderBase = function () {}, a.ProviderBase.prototype = {
        ...
        geodecode: function geodecode() {},
        mapToGeocoded: function mapToGeocoded() {},
...
if (function (a) {
    ...
    a.Geocoded = function () {}, a.Geocoded.prototype = {
        ...
        getStreetNumber: function getStreetNumber() {
            return this.streetNumber;
        },
        getStreetName: function getStreetName() {
        ...
        getCityDistrict: function getCityDistrict() {},
        getCounty: function getCounty() {},
        getCountyCode: function getCountyCode() {},
...
if (function (a, b) {
    ...
    function c(a) {
        var c = Date.now(),
            d = "jsonp" + Math.round(c + 1000001 * Math.random());
    ...
    a.ExternalURILoader = function (a) {
        ...
        for (var c in b) {
            this.options[c] = void 0 !== a[c] ? a[c] : b[c];
        }
    }, a.ExternalURILoader.prototype.executeRequest = function (b, d) {
        function e(b, c) {
            var d,
                e = require("url"),
                f = require(g.options.protocol),
                h = {
                ...
                b.data = "", b.setEncoding("utf8"), b.on("data", function (a) {
                    ...
                    if (d && d.status) {
                        ...
                        if ("OK" === d.status && d.results) {
                            for (; e < d.results.length; e++) {
                                f.push(a.GoogleAPIProvider.prototype.mapToGeocoded(d.results[e]));
                            }return c(f);
                        }
                    }
        ...
        function f(a, b) {
            var d,
                ...
                f = g.options.protocol + "://" + g.options.host + "/" + g.options.pathname + "?",
                h = [];
            a.JSONPCallback && (d = a.JSONPCallback, delete a.JSONPCallback, a[d] = c(b));
            for (var i in a) {
                a.hasOwnProperty(i) && h.push(i + "=" + a[i]);
            }if (f += h.join("&"), d) {
                var j = document.createElement("script");
                j.src = f, document.getElementsByTagName("head")[0].appendChild(j);
            } else e.onload = function () {
                if (200 != this.status) return console.log("Received HTTP status code " + this.status + " when attempting geocoding request."), b(null);
                if (!this.responseText || !this.responseText.length) return console.log("Received empty data when attempting geocoding request."), b(null);
                var a = !1;
                try {
                    a = JSON.parse(this.responseText);
                } catch (c) {
                    return console.log("Received invalid JSON data when attempting geocoding request."), b(null);
                }
                return a ? b(a) : (console.log("Received unexpected JSON data when attempting geocoding request."), b(null));
            }, e.open("GET", f), e.send();
        }
        var g = this;
...
if (function (a) {
    ...
    a.BingProvider = function (a, d) {
        ...
        this.externalLoader = a, d = d ? d : {}, b = d.useSSL ? d.useSSL : !1, c = d.apiKey ? d.apiKey : null, c && (b = !0);
    }, a.BingProvider.prototype = new a.ProviderBase(), a.BingProvider.prototype.constructor = a.BingProvider, a.BingProvider.prototype.geocode = function (a, d) {
        ...
        this.externalLoader.executeRequest(a, function (a) {
            var d = [];
            for (var e in a.resourceSets[0].resources) {
                d.push(c.mapToGeocoded(a.resourceSets[0].resources[e]));
            }b(d);
        });
    }, a.BingProvider.prototype.mapToGeocoded = function (b) {
        var c = new a.Geocoded();
        return c.latitude = b.point.coordinates[0], c.longitude = b.point.coordinates[1], c.streetName = b.address.addressLine, c.city = b.address.locality, c.region = b.address.adminDistrict, c.postal_code = b.address.postalCode, c;
    };
}(GeocoderJS), "undefined" == typeof GeocoderJS && "function" == typeof require) {
    var GeocoderJS = require("../GeocoderJS.js");
    require("../Geocoded.js"), require("../providers/ProviderBase.js");
...
if (function (a) {
    ...
    a.GoogleAPIProvider = function (a, d) {
        if (void 0 === a) throw "No external loader defined.";
        this.externalLoader = a, d = d ? d : {}, b = d.useSSL ? d.useSSL : !1, c = d.apiKey ? d.apiKey : null, c && (b = !0);
    }, a.GoogleAPIProvider.prototype = new a.ProviderBase(), a.GoogleAPIProvider.prototype.constructor = a.GoogleAPIProvider, a.GoogleAPIProvider.prototype.geocode = function (a, d) {
        this.externalLoader.setOptions({
            protocol: b === !0 ? "https" : "http",
        ...
        this.externalLoader.executeRequest(a, function (a) {
            var d = [];
            for (var e in a.results) {
                d.push(c.mapToGeocoded(a.results[e]));
            }b(d);
        });
        ...
        for (var d in b.address_components) {
            for (var e in b.address_components[d].types) {
                switch (b.address_components[d].types[e]) {
                    case "street_number":
...
if (function (a) {
    ...
    a.MapquestProvider = function (a, b) {
        if (void 0 === a) throw "No external loader defined.";
        this.externalLoader = a, "object" != (typeof b === "undefined" ? "undefined" : _typeof(b)) && (b = {});
        var c = {
            apiKey: ""
        };
        for (var d in c) {
    ...
    }, a.MapquestProvider.prototype = new a.ProviderBase(), a.MapquestProvider.prototype.constructor = a.MapquestProvider, a.MapquestProvider.prototype.geocode = function (a, b) {
        this.externalLoader.setOptions({
            protocol: "http",
        ...
        var c = new a.Geocoded();
        return c.latitude = b.latLng.lat, c.longitude = b.latLng.lng, c.city = b.adminArea5, c.region = b.adminArea4, c.streetName = b.street, c.postal_code = b.postalCode, c;
    }, a.MapquestProvider.prototype.executeRequest = function (a, b) {
        var c = this;
        this.externalLoader.executeRequest(a, function (a) {
            var d = [];
            if (a.results[0].locations.length) for (var e in a.results[0].locations) {
                d.push(c.mapToGeocoded(a.results[0].locations[e]));
            }b(d);
        });
    };
}(GeocoderJS), "undefined" == typeof GeocoderJS && "function" == typeof require) {
...
if (function (a) {
    ...
    a.OpenStreetMapProvider = function (a) {
    ...
    }, a.OpenStreetMapProvider.prototype = new a.ProviderBase(), a.OpenStreetMapProvider.prototype.constructor = a.OpenStreetMapProvider, a.OpenStreetMapProvider.prototype.geocode = function (a, b) {
        this.externalLoader.setOptions({
            protocol: "http",
        ...
        this.externalLoader.executeRequest(a, function (a) {
            var d = [];
            if (a.length) for (var e in a) {
                d.push(c.mapToGeocoded(a[e]));
            } else d.push(c.mapToGeocoded(a));
            b(d);
        });
    }, a.OpenStreetMapProvider.prototype.mapToGeocoded = function (b) {
        var c = new a.Geocoded();
        return c.latitude = 1 * b.lat, c.longitude = 1 * b.lon, c.streetNumber = void 0 !== b.address.house_number ? b.address.house_number : void 0, c.streetName = b.address.road, c.city = b.address.city, c.region = b.address.state, c.postal_code = b.address.postcode, c;
    };
}(GeocoderJS), "undefined" == typeof GeocoderJS && "function" == typeof require) {
    var GeocoderJS = require("../GeocoderJS.js");
    require("../Geocoded.js"), require("../providers/ProviderBase.js");
...
!function (a) {
    ...
    a.YandexProvider = function (a, c) {
    ...
    }, a.YandexProvider.prototype = new a.ProviderBase(), a.YandexProvider.prototype.constructor = a.YandexProvider, a.YandexProvider.prototype.geocode = function (a, c) {
        this.externalLoader.setOptions({
            protocol: b === !0 ? "https" : "http",
        ...
        this.externalLoader.executeRequest(a, function (a) {
            var d = [];
            for (var e in a.response.GeoObjectCollection.featureMember) {
                d.push(c.mapToGeocoded(a.response.GeoObjectCollection.featureMember[e].GeoObject));
            }b(d);
        });
        ...
        if (c.latitude = d[1], c.longitude = d[0], b.metaDataProperty.GeocoderMetaData.AddressDetails.Country) {
            ...
            e.AdministrativeArea && (e = e.AdministrativeArea, c.region = e.AdministrativeAreaName, e.SubAdministrativeArea && (e = e.SubAdministrativeArea, e.Locality && (e = e.Locality, c.city = e.LocalityName, e.Thoroughfare && (e = e.Thoroughfare, c.streetName = e.ThoroughfareName))));
        }
        return c;
    };
}(GeocoderJS);